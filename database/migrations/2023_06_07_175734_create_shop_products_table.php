...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('shop_products', static function (Blueprint $table) {
            ...
            $table->decimal('weight_value', 10, 2)->unsigned()->nullable()->default(0.00);
            $table->string('weight_unit')->default('kg');
            $table->decimal('height_value', 10, 2)->unsigned()->nullable()->default(0.00);
            $table->string('height_unit')->default('cm');
            $table->decimal('width_value', 10, 2)->unsigned()->nullable()->default(0.00);
            $table->string('width_unit')->default('cm');
            $table->decimal('depth_value', 10, 2)->unsigned()->nullable()->default(0.00);
            $table->string('depth_unit')->default('cm');
            $table->decimal('volume_value', 10, 2)->unsigned()->nullable()->default(0.00);
