...
const form = useForm({
    ...
    transmission_type: props.vehicle.transmission_type,
...
const updateVehicle = () => {
    form.put(route('vehicles.update', { id: vehicleId.value }), {
        preserveScroll: true,
        onSuccess: () => showSuccessMessage('Success', 'Your vehicle was updated!')
    })
}
</script>
