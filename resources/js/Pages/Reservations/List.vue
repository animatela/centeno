...
interface Props {
    ...
    reservations: Array<Workshop.Reservation>
            ...
            <div class="max-w-screen-xl mx-auto sm:px-6 lg:px-8">
                ...
                <section class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table v-if="reservations" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                            ...
                            <tbody>
                            <tr v-for="reservation in reservations" class="border-b dark:border-gray-700">
                                <th scope="row"
                                ...
                                <td class="px-4 py-3">{{ vehicleName(reservation.vehicle_id) }}</td>
                                <td class="px-4 py-3">{{ serviceName(reservation.service_id) }}</td>
                                <td class="px-4 py-3">{{ currencyName(reservation.currency) }}</td>
